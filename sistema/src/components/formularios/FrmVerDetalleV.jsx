...
const FrmVerDetalleV = () => {
  ...
  return (
    <div>
      ...
      <Form.Group style={{marginTop:'-5px', marginLeft:'1px', display:'flex'}} as={Row} className="mb-3" controlId="formPlaintextPassword">
        <Col sm="2">
          <Form.Control style={{width:'290px'}} type='text' placeholder="Número de Documento" />
        </Col>
        <Col sm="2">
          <Form.Control style={{marginLeft:'210px', width:'500px'}} type='text' placeholder="Nombre Completo" disabled readOnly />
        </Col>
